...
const latestNewsInfo = [
  {
    image: tech1,
    date: '22,oct,2021',
    question: 'Who avoids a',
    question2: 'pain that produces?',
    description: 'Lorem ipsum dolor sit amet',
    description2: 'consectetur. Nec sit enim tellus faucibus',
    description3: 'bibendum ullamcorper. Phasellus',
    description4: 'tristique aenean at lorem sed',
    description5: 'scelerisque.',
    note: 'By spacing tech',
  },
  {
    image: tech2,
    date: '22,oct,2021',
  ...
  return (
    <section>
      <div className={cls.logo_news}>
        <Text className={cls.logo_txt} as="h6" fz={25} fw={600}>
          Latest news
        </Text>
