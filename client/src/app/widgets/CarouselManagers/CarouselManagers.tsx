...
const managersInfo = [
  {
    ...
    description: 'Lorem ipsum dolor sit amet consectetur. Nec sit',
    description2: 'enim tellus faucibus bibendum ullamcorper.',
    description3: 'Phasellus tristique aenean at lorem sed scelerisque.',
  },
  {
    avatarUrl: manager2,
    name: 'Esther Howard',
